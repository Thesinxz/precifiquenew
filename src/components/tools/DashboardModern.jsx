...
import {
    ...
    ShoppingBag, Plus, ArrowUpRight, Clock, CheckCircle2, Zap,
    AlertCircle, Calendar, Target, Activity as ActivityIcon,
    FileText, Wallet, Landmark, ScrollText, MessageSquare,
    Calculator, Instagram, Store, Link, Bell, Search
} from 'lucide-react';
...
export function DashboardModern({ user, userProfile, settings, darkMode }) {
    ...
    const MetricCard = ({ icon: Icon, label, value, trend, color = 'indigo', onClick }) => (
        <div
            onClick={onClick}
            className={cn(
